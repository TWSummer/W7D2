...
exports.destroyTodo = exports.changeTodoStatus = exports.createTodo = exports.fetchTodos = exports.changeDetail = exports.changeStatus = exports.removeTodo = exports.receiveTodos = exports.receiveTodo = exports.FETCH_TODOS = exports.CHANGE_DETAIL = exports.CHANGE_STATUS = exports.REMOVE_TODO = exports.RECEIVE_TODO = exports.RECEIVE_TODOS = undefined;

var _todo_api_util = __webpack_require__(177);

var _error_actions = __webpack_require__(179);

var _step_actions = __webpack_require__(183);
...
var CHANGE_DETAIL = exports.CHANGE_DETAIL = 'CHANGE_DETAIL';
...
var changeStatus = exports.changeStatus = function changeStatus(todoId) {
  return {
    type: CHANGE_STATUS,
    todoId: todoId
  };
...
var changeDetail = exports.changeDetail = function changeDetail(todoId) {
  return {
    type: CHANGE_DETAIL,
    todoId: todoId
  };
...
var fetchTodos = exports.fetchTodos = function fetchTodos() {
  return function (dispatch) {
    return (0, _todo_api_util.getTodos)().then(function (todosFromServer) {
...
var createTodo = exports.createTodo = function createTodo(todo) {
  return function (dispatch) {
    return (0, _todo_api_util.addTodo)(todo).then(function (newTodo) {
...
var changeTodoStatus = exports.changeTodoStatus = function changeTodoStatus(todo) {
  return function (dispatch) {
    todo.done = !todo.done;
    return (0, _todo_api_util.updateTodo)(todo).then(function (updatedTodo) {
...
var destroyTodo = exports.destroyTodo = function destroyTodo(todo) {
  return function (dispatch) {
    return (0, _todo_api_util.deleteTodo)(todo).then(function () {
...
var allSteps = exports.allSteps = function allSteps(state) {
  return Object.keys(state.steps).map(function (key) {
...
var _step_reducer = __webpack_require__(182);
...
var todoReducer = function todoReducer() {
  ...
  switch (action.type) {
    ...
    case _todo_actions.RECEIVE_TODOS:
      newState = {};
      action.todos.forEach(function (element) {
    ...
    case _todo_actions.REMOVE_TODO:
      ...
      return newState;
    case _todo_actions.CHANGE_STATUS:
      newState = (0, _merge2.default)({}, state);
      newState[action.todoId].done = !newState[action.todoId].done;
      return newState;
    case _todo_actions.CHANGE_DETAIL:
      newState = (0, _merge2.default)({}, state);
...
var mapStateToProps = function mapStateToProps(state) {
  return {
    ...
    errors: state.errors,
    steps: (0, _selectors.allSteps)(state)
  };
};
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    changeTodoStatus: function changeTodoStatus(todoId) {
      return dispatch((0, _todo_actions.changeTodoStatus)(todoId));
    },
    changeDetail: function changeDetail(todoId) {
      return dispatch((0, _todo_actions.changeDetail)(todoId));
    },
    ...
    fetchSteps: function fetchSteps(todo) {
      return dispatch((0, _step_actions.fetchSteps)(todo));
    }
  };
};
        ...
        _react2.default.createElement(
          ...
          this.props.todos.map(function (todo, idx) {
            return _react2.default.createElement(_todo_list_item2.default, { key: todo.id,
              todo: todo,
              changeTodoStatus: _this2.props.changeTodoStatus,
              changeDetail: _this2.props.changeDetail,
              fetchSteps: _this2.props.fetchSteps,
              steps: _this2.props.steps[todo.id] });
          })
        ),
...
var _uniq_id = __webpack_require__(174);

var _uniq_id2 = _interopRequireDefault(_uniq_id);
  ...
  _createClass(TodoForm, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { onChange: this.updateTitle, type: 'text', id: 'title' }),
        ...
        _react2.default.createElement('textarea', { onChange: this.updateBody, id: 'body' }),
        _react2.default.createElement('br', null),
        _react2.default.createElement(
          'button',
          null,
...
var _todo_detail_view = __webpack_require__(176);

var _todo_detail_view2 = _interopRequireDefault(_todo_detail_view);

var _todo_detail_view_container = __webpack_require__(181);
...
var TodoListItem = function (_React$Component) {
  ...
  _createClass(TodoListItem, [{
    ...
    value: function changeTodoStatus(e) {
      e.preventDefault();
      this.props.changeTodoStatus(this.props.todo);
    }
  }, {
    key: 'changeDetail',
    value: function changeDetail(e) {
      e.preventDefault();
    ...
    value: function render() {
      ...
      if (this.props.todo.detail) {
        detail = _react2.default.createElement(_todo_detail_view_container2.default, { todo: this.props.todo, steps: this.props.steps });
      }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { onClick: this.changeTodoStatus.bind(this) },
          buttontext
        ),
        detail
      );
...
var TodoDetailView = function (_React$Component) {
  ...
  _createClass(TodoDetailView, [{
    ...
    key: "render",
    value: function render() {
      var steps = this.props.steps[this.props.todo.id];
      console.log(steps);
      var stepString = "";
      if (steps) {
        stepString = steps.map(function (step) {
          return step.title;
        });
      }
      return _react2.default.createElement(
...
exports.fetchSteps = exports.receiveSteps = exports.RECEIVE_STEPS = undefined;

var _step_api_util = __webpack_require__(184);

var RECEIVE_STEPS = exports.RECEIVE_STEPS = 'RECEIVE_STEPS';

var receiveSteps = exports.receiveSteps = function receiveSteps(steps, todo) {
  return {
    type: RECEIVE_STEPS,
    steps: steps,
    todo: todo
...
var fetchSteps = exports.fetchSteps = function fetchSteps(todo) {
  return function (dispatch) {
    return (0, _step_api_util.getSteps)(todo).then(function (stepsFromServer) {
...
var getSteps = exports.getSteps = function getSteps(todo) {
  return $.ajax({
    method: 'GET',
